...
public class DepartmentControllerUnitTest {
    ...
    public void createDepartmentTest() {
        ...
        Mockito.when(departmentService.createDepartment(Mockito.any())).thenReturn(Mono.just(departmentData));
    ...
    public void createDepartmentTestException() {
        Mockito.when(departmentService.createDepartment(Mockito.any())).thenReturn(Mono.error(new Exception("Test")));
        Mono<ResponseEntity<DepartmentModel>> response =
                departmentController.createDepartment(departmentData);
